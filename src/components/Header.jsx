  ...
  return (
    <header className="min-w-2/6 pl-4 bg-slate-900 opacity-95 flex flex-col justify-around items-center ">
      ...
      <div className="h-[100px] flex justify-center items-center rounded-lg ">
        <button onClick={handleLogout} class="group flex items-center justify-start w-11 h-11 bg-red-600 rounded-full cursor-pointer relative overflow-hidden transition-all duration-200 shadow-lg hover:w-32 hover:rounded-lg active:translate-x-1 active:translate-y-1">
